...
mod tests {
    ...
    use super::{
        DimOrder, ImageSource, Model, OcrEngine, OcrEngineParamsImpl, DEFAULT_ALPHABET,
    };
            ...
            .push(
                [
                    Rect::from_tlhw(
                            0,
                            0,
                            image.shape()[1] as i32,
                            image.shape()[2] as i32,
                        )
                        .to_f32(),
                ]
